...
public class Caesar
{
    ...
    {
        this("qQwWeErRtTyYuUiIoOpPaAsSdDfFgGhHjJkKlLzZxXcCvVbBnNmM1234567890", seed);
    }
    ...
    public static void main(String[] args)
    {
        ...
        String tmp = String.format("%036d", current);
        System.out.println("tmp=" + tmp);
        Caesar caesar = new Caesar("qQwWeErRtTyYuUiIoOpPaAsSdDfFgGhHjJkKlLzZxXcCvVbBnNmM1234567890");
        String data = caesar.encode(key, tmp);
        System.out.println(data);
        String pass = caesar.decode(key, data);
